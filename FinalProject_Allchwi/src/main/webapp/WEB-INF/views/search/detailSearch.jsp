		...
		<p>입력된 검색어 : ${keyword }</p>
        	<form class="form-inline">
			  ...
			  <div class="custom-control custom-checkbox my-1 mr-sm-2">
			    ...
			    <label class="custom-control-label" for="customControlInline">지역 고정하기</label>
			  </div>
			
			  <button type="submit" class="btn btn-primary my-1">상세검색</button>
			</form>
        <p>
...
<div class="jumbotron">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4"><!-- 이부분 나중에 :  select 된 자료를 동적으로 생성하기 (제이쿼리,json)-->
